...
Our app has three pages:
  1. A login page, where the user enters their name. No passwords; we'll just trust them. After they're logged in, users are taken to...
  2. A user homepage, which says, "Hi, #{name}", and has a link to the secret page, which is...
